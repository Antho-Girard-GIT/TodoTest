...
export default function App() {
  ...
  return (
    ...
    <div className="flex justify-center pt-40 p-10">
      <form action={onFormAction} className="flex justify-center gap-5 ">
        <input name="todo" className="w-24 md:w-48 lg:w-84 sm:w-32 xl:w-100 rounded-md ring-4 ring-amber-300 bg-stone-300 font-bold p-2 text-amber-900" />
        <button
          type="submit"
      ...
      <ul className="flex flex-col gap-4 font-mono">
        {todos.map((todo) => (
          <li key={todo.id} className="bg-zinc-200 px-4 py-2 rounded flex items-center w-full">
